...
class APMHook(Hook):
    def __init__(self, args, apm_log_hook) -> None:
        ...
        self.apm_labels = torch.ones((self.num_heads, self.ulb_dest_len)).to(args.device) * -1
    ...
    def after_train_epoch(self, algorithm):
        ...
        self.apm_labels = torch.ones((self.num_heads, self.ulb_dest_len)).to(self.args.device) * -1
