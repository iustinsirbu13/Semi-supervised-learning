...
class ClassificationDebertaMultihead(nn.Module):
    def __init__(self, name, num_classes=2, num_heads=3, adjust_clf_size=False):
        super(ClassificationDebertaMultihead, self).__init__()
...
def deberta_v3_base_multihead(args, **kwargs):
    print("GOT DEBERTA MODEL\n", )
    model = ClassificationDebertaMultihead('microsoft/deberta-v3-base', args.num_classes, args.num_heads, args.adjust_clf_size, **kwargs)
    return model
