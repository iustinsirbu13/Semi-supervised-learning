...
from disaster_tweet.wrappers.freematch.freematch_mmbt_base_wrapper import FreeMatchMMBTBaseWrapper


class FreeMatchMMBTBertWrapper(FreeMatchMMBTBaseWrapper):
    ...
    def validate_algo(self, config):
        assert config.algorithm == ALGO_WRAPPERS.FREEMATCH_MMBT_BERT
