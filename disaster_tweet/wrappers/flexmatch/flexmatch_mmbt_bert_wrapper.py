...
from disaster_tweet.wrappers.flexmatch.flexmatch_mmbt_base_wrapper import FlexMatchMMBTBaseWrapper


class FlexMatchMMBTBertWrapper(FlexMatchMMBTBaseWrapper):
