...
from disaster_tweet.wrappers.marginmatch.marginmatch_mmbt_base_wrapper import MarginMatchMMBTBaseWrapper


class MarginMatchMMBTBertWrapper(MarginMatchMMBTBaseWrapper):
    ...
    def validate_algo(self, config):
        assert config.algorithm == ALGO_WRAPPERS.MARGINMATCH_MMBT_BERT
