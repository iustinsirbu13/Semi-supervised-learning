...
class AlgorithmBase:
    ...
    def predict_tmp(self, eval_dest='eval', out_key='logits', return_logits=False):
        """
        evaluation function
        """
        self.model.eval()
        ...
        save_path = os.path.join(self.save_dir, self.save_name, f'predict_{eval_dest}.json')
        self.print_fn('save_path for predict_tmp()' + str(save_path))
