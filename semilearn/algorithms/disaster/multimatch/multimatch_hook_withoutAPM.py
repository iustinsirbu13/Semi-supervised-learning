...
def check_apm_agreement_without_apm(value):
    if value in [MultiheadAgreementTypes.HighConfAgreement, MultiheadAgreementTypes.DiffConfAgreement, MultiheadAgreementTypes.UnkConfAgreement, MultiheadAgreementTypes.LowConfAgreement]:
        return 1 # agreement
    else:
        return -1 # disagreement


class MultiMatchHookWithoutAPM(Hook):
    ...
    def get_apm_label_v2(self, algorithm, idx, label1, label2, head_id, head_id1, head_id2):
        ...
        assert self.args.multihead_apm_variant == 'v-apm'
        check_apm_agreement = check_apm_agreement_without_apm

        # if self.args.multihead_apm_variant in ['v3', 'v4', 'v5', 'v6', 'v8']:
