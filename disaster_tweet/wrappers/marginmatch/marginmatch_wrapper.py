...
from disaster_tweet.wrappers.marginmatch.marginmatch_base_wrapper import MarginMatchBaseWrapper

class MarginMatchWrapper(MarginMatchBaseWrapper):

    def __init__(self, config, build_algo=True):
        assert config.algorithm == ALGO_WRAPPERS.MARGINMATCH
        ...
        # MarginMatch requires hard labels
