...
def get_dataset(args, algorithm, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True, text_weak_aug=None, text_strong_aug=None, load_labeled=False):
    ...
    elif dataset in ['wildguardmix_PH_eda', 'wildguardmix_PH_translate', 'wildguardmix_RH_eda', 'wildguardmix_RH_translate', 'OAIMod_PH', 'XSTest_PH', 'OAIMod_PH_NN', 'XSTest_RH', 'wildguardmix_RH_translate_eda', 'wildguardmix_PH_translate_test', 'aegis1.0_PH_eda', 'aegis1.0_PH_eda_2', 'aegis_PH_multiclass_eda', 'aegis2.0_PH_multiclass_eda', 'aegis2.0_PH_eda', 'aegis2.0_RH_eda', 'wildguardmix_PH_translate_MarianMT_test', 'wildguardmix_PH_paraphrase', 'wildguardmix_PH_translate_paraphrase', 'wildguardmix_PH_paraphrase_2', 'wildguardmix_PH_paraphrase_mistral', 'wildguardmix_PH_paraphrase_mistral_2', 'wildguardmix_PH_paraphrase_mistral_llama', 'wildguardmix_PH_paraphrase_mistral_llama_2', 'aegis2.0_PH_eda_2', 'wildguardmix_PH_paraphrase_2_multiclass', 'wildguardmix_RH_translate_MarianMT', 'wildguardmix_PH_paraphrase_catsplit', 'wildguardmix_RH_paraphrase', 'wildguardmix_RH_paraphrase_mistral', 'wildguardmix_RH_paraphrase_mistral_llama', 'wildguardmix_RH_paraphrase_translate_weak_llm_strong', 'wildguardmix_RH_paraphrase_mistral_2', 'wildguardmix_RH_paraphrase_mistral_2aug']:
