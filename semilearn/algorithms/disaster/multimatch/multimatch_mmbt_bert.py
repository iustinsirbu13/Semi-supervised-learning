import torch
from semilearn.algorithms.disaster.multimatch.multimatch import MultiMatch
from semilearn.core.utils import ALGORITHMS


@ALGORITHMS.register('multimatch_mmbt_bert')
class MultiMatchMMBTBert(MultiMatch):
    def __init__(self, args, net_builder, tb_log=None, logger=None):
        print('INITIALIZE MULTIMATCH_MMBT_BERT')
    ...
    def train_step(self,
        ...
        if self.use_cat:
            ...
            assert self.args.save_pseudolabels_stats == False # because of None for the last argument
            return self.train_step_base(logits, lb_target, idx_ulb, None)
        else:
